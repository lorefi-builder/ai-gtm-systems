// Embedded discovery-call transcripts (the browser can't read the seed/ files
// off disk, so they're inlined here verbatim from seed/transcripts/*.md).
// Exposed on window.TRANSCRIPTS for app.js.

window.TRANSCRIPTS = {
  meridian: {
    label: "Meridian Synth (clean)",
    sublabel: "Technology × Data Labeling — green, clean single project",
    text: `# Discovery Call — Meridian Synth (Technology) × Lorefi
...
`,
  ...
  cedarbrook: {
    label: "Cedarbrook Health (edge case)",
    sublabel: "Healthcare × Conversational AI — red, PHI + multi-project",
    text: `# Discovery Call — Cedarbrook Health Network (Healthcare) × Lorefi
...
`,
  ...
  veritas: {
    label: "Veritas Analytics (stress test)",
    sublabel: "Financial Services × retrieval/eval — real off-template, two combined calls",
    text: `# Discovery Call — Veritas Analytics (Financial Services) × Snorkel
...
`,
  ...
  ambiguous: {
    label: "Brightshelf (ambiguous / low-confidence)",
    sublabel: "Retail-tech — reads as Technology OR Retail, Content Gen OR Data Labeling; all candidate cells GREEN, review trigger is low confidence only",
    text: `# Discovery Call — Brightshelf (Commerce / Retail-Tech) × Lorefi
